        ...
        <div className="guilds">
            <div className="tree">
                <ul className="tree-list">
                    <li className="tree-item direct">
                        <div className="line-indicate"></div>
                        <div className="item-wrap">
                            <svg
                                className="home-icon-r0w4ny"
                                role="img"
                                viewBox="0 0 28 20"
                            >
                    ...
                    <li className="tree-item giuld-separator"></li>
                    <ul className="servers">
                        <li className="tree-item guild">
                            <div className="line-indicate"></div>
                            <div className="item-wrap">
                                <img
                                    className="icon-3AqZ2e "
                                    src="https://cdn.discordapp.com/icons/613425648685547541/a_6375907799aa6ff2499a1e729a594739.webp?size=96"
                                />
                            </div>
                        </li>
                        <li className="tree-item guild">
                            ...
                            <div className="item-wrap">
                                <img
                                    className="icon-3AqZ2e"
                                    src="https://cdn.discordapp.com/icons/508357248330760243/e6ca01fc39a99cc2172b65249f0c101f.webp?size=96"
                                />
                            </div>
                        </li>
                    </ul>
